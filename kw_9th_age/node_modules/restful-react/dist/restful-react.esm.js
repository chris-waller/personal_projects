  ...
  try {
    var _temp4 = function _temp4(propsRequestOptions) {
      function _temp2(contextRequestOptions) {
        ...
        var request = new Request(resolvePath(base, pathStr, _extends({}, context.queryParams, {}, queryParams), _extends({}, context.queryParamStringifyOptions, {}, queryParamStringifyOptions)), merge({}, contextRequestOptions, propsRequestOptions, {
          signal: signal
        }));
    ...
    try {
      var _temp7 = function _temp7(propsRequestOptions) {
        function _temp5(contextRequestOptions) {
          ...
          var signal = getAbortSignal();
          var request = new Request(resolvePath(base, pathParts.join("/"), _extends({}, context.queryParams, {}, queryParams, {}, mutateRequestOptions === null || mutateRequestOptions === void 0 ? void 0 : mutateRequestOptions.queryParams), _extends({}, context.queryParamStringifyOptions, {}, props.queryParamStringifyOptions)), merge({}, contextRequestOptions, options, propsRequestOptions, mutateRequestOptions, {
            signal: signal
          }));
          if (context.onRequest) context.onRequest(request);
          var response;
