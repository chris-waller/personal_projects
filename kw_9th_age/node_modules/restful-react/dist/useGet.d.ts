...
declare type RefetchOptions<TData, TQueryParams, TPathParams> = Partial<Omit<UseGetProps<TData, TQueryParams, TPathParams>, "lazy">>;
...
export declare function useGet<TData = any, TError = any, TQueryParams = {
    [key: string]: any;
}, TPathParams = unknown>(path: UseGetProps<TData, TQueryParams, TPathParams>["path"], props?: Omit<UseGetProps<TData, TQueryParams, TPathParams>, "path">): UseGetReturn<TData, TError, TQueryParams>;
export declare function useGet<TData = any, TError = any, TQueryParams = {
    [key: string]: any;
}, TPathParams = unknown>(props: UseGetProps<TData, TQueryParams, TPathParams>): UseGetReturn<TData, TError, TQueryParams>;
export {};
