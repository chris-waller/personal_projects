          ...
          return _catch(function () {
            return Promise.resolve(fetch(request, {
              ...
              return Promise.resolve(processResponse(response)).then(function (_ref) {
                ...
                if (onResponse) onResponse(response); // avoid state updates when component has been unmounted
  ...
  try {
    var _temp4 = function _temp4(propsRequestOptions) {
      function _temp2(contextRequestOptions) {
        ...
        var request = new Request(resolvePath(base, pathStr, _extends({}, context.queryParams, {}, queryParams), props.queryParamStringifyOptions || {}), merge({}, contextRequestOptions, propsRequestOptions, {
          signal: signal
        }));
      ...
      return _temp ? Promise.resolve(context.requestOptions()).then(_temp2) : _temp2(context.requestOptions);
    };
    ...
    return Promise.resolve(typeof requestOptions === "function" ? Promise.resolve(typeof requestOptions === "function" ? requestOptions() : requestOptions).then(_temp4) : _temp4(typeof requestOptions === "function" ? requestOptions() : requestOptions));
  } catch (e) {
    return Promise.reject(e);
  }
};
...
function useGet() {
  ...
  return _extends({}, state, {
    absolutePath: resolvePath(props.base || context.base, pathStr, _extends({}, context.queryParams, {}, props.queryParams), props.queryParamStringifyOptions),
    ...
    try {
      var _temp7 = function _temp7(propsRequestOptions) {
        function _temp5(contextRequestOptions) {
          ...
          var signal = getAbortSignal();
          var request = new Request(resolvePath(base, isDelete ? pathStr + "/" + body : pathStr, _extends({}, context.queryParams, {}, queryParams, {}, mutateRequestOptions === null || mutateRequestOptions === void 0 ? void 0 : mutateRequestOptions.queryParams), props.queryParamStringifyOptions), merge({}, contextRequestOptions, options, propsRequestOptions, mutateRequestOptions, {
            signal: signal
          }));
          if (context.onRequest) context.onRequest(request);
          var response;
